  ...
  <main class="main">
    <div class="topbar">
      ...
      <div class="top-actions">
        <div class="user-pill"><span>{currentUser?.display_name || '管理员'}</span><b>Admin</b></div>
    ...
    <div class="content">
      ...
      {:else}
        ...
        {#if activeTab === 'overview'}
          <div class="page-head">
            <div><h1 class="page-title">运营概览</h1><p class="page-desc">查看平台用户、积分余额、积分消耗和流水总览。</p></div>
          </div>
          <div class="metrics">
        ...
        {#if activeTab === 'users'}
          <div class="page-head"><div><h1 class="page-title">用户管理</h1><p class="page-desc">管理用户状态、查看积分余额。这里不进入任何用户的内容生产工作区。</p></div></div>
        ...
        {#if activeTab === 'points'}
          <div class="page-head"><div><h1 class="page-title">积分调整</h1><p class="page-desc">为用户手动发放或扣减积分，并生成可追溯的积分流水。</p></div></div>
        ...
        {#if activeTab === 'ledger'}
          <div class="page-head"><div><h1 class="page-title">积分流水</h1><p class="page-desc">查看全平台积分充值、赠送、消耗和后台调整记录。</p></div></div>
