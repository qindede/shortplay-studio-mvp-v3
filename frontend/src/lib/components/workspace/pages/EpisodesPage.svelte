...
<div class="episode-board">
  <div class="panel">
    ...
    <div class="panel-body">
      <div class="episode-list">
        ...
        <button class="empty-card" style="min-height: 86px;" on:click={createEpisode}>
  ...
  <div class="panel">
    <div class="panel-head">
      <div>
        <div class="panel-title">剧集列表</div>
        <div class="panel-subtitle">查看每集制作状态与下一步动作。</div>
      </div>
    </div>

    <div class="panel-body table-wrap">
      <table class="table">
        <thead><tr><th>剧集</th><th>剧情摘要</th><th>分镜</th><th>视频版本</th><th>时长</th><th>状态</th><th>操作</th></tr></thead>
        <tbody>
          {#each episodes as episode}
            <tr>
