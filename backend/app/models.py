...
class AiJob(Base):
    ...
    project_id: Mapped[str | None] = mapped_column(String, ForeignKey("projects.id", ondelete="SET NULL"), index=True)
    episode_id: Mapped[str | None] = mapped_column(String, ForeignKey("episodes.id", ondelete="SET NULL"), index=True)
    shot_id: Mapped[str | None] = mapped_column(String, ForeignKey("shots.id", ondelete="SET NULL"), index=True)
    asset_id: Mapped[str | None] = mapped_column(String, ForeignKey("assets.id", ondelete="SET NULL"), index=True)
    type: Mapped[str] = mapped_column(String(32), nullable=False)
