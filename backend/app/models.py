...
class AiJob(Base):
    ...
    shot_id: Mapped[str | None] = mapped_column(String, ForeignKey("shots.id"), index=True)
    asset_id: Mapped[str | None] = mapped_column(String, ForeignKey("assets.id"), index=True)
    type: Mapped[str] = mapped_column(String(32), nullable=False)
